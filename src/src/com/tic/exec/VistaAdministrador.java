...
public class VistaAdministrador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setActionCommand("GESTIONAR DISPOSITIVOS");
        jButton1.addActionListener(this::jButton1ActionPerformed);
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, -1, -1));

        jButton2.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        jButton2.setText("LISTAR INCIDENCIAS");
        jButton2.setPreferredSize(new java.awt.Dimension(264, 28));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 230, -1, -1));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 270, -1, -1));

        jButton7.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        jButton7.setText("LISTAR USUARIOS");
        jButton7.setPreferredSize(new java.awt.Dimension(264, 28));
        jButton7.addActionListener(this::jButton7ActionPerformed);
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, -1, -1));

        jButton8.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        jButton8.setText("LISTAR DISPOSITIVOS");
        jButton8.setPreferredSize(new java.awt.Dimension(264, 28));
        jButton8.addActionListener(this::jButton8ActionPerformed);
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, -1, -1));

        jButton9.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        jButton9.setText("LISTAR ESPACIOS");
        jButton9.setPreferredSize(new java.awt.Dimension(264, 28));
        jButton9.addActionListener(this::jButton9ActionPerformed);
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, -1, -1));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 360, 190, 130));
        ImageIcon icon = new ImageIcon(getClass().getResource("/img/lu.png"));
