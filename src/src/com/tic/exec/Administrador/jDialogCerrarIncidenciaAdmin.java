 ...
 * @author alumno
 */
public class jDialogCerrarIncidenciaAdmin extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(jDialogCerrarIncidenciaAdmin.class.getName());
    TecnicoDAOimpl tecnicoDAO = new TecnicoDAOimpl();

    /**
     * Creates new form jDialogCerrarIncidencia
     */
    public jDialogCerrarIncidenciaAdmin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                jDialogCerrarIncidenciaAdmin dialog = new jDialogCerrarIncidenciaAdmin(new javax.swing.JFrame(), true);
